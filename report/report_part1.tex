...
This report explains the parts of \cite{dhulipala2023efficient} that are difficult to understand and presents the replication results obtained using TensorFlow.

\section{Typos and Explaination}
\begin{itemize}
...
\begin{figure}
\centering
\subcaptionbox{\label{fig:2a}}{\includegraphics[width=0.3\textwidth]{../figures/fig2a.png}}
\subcaptionbox{\label{fig:2b}}{\includegraphics[width=0.3\textwidth]{../figures/fig2b.png}}
\subcaptionbox{\label{fig:2c}}{\includegraphics[width=0.3\textwidth]{../figures/fig2c.png}}
...
\begin{figure}
\centering
\subcaptionbox{\label{fig:3a}}{\includegraphics[width=0.3\textwidth]{../figures/fig3a.png}}
\quad 
\subcaptionbox{\label{fig:3b}}{\includegraphics[width=0.3\textwidth]{../figures/fig3b.png}}
...
\end{array}\right. .
\end{align*}
In the implementation, the correct density is used. L-HNNs are trained on a sampling of the 2-D Neal’s funnel density, the 5-D ill-conditioned Gaussian density, and the 10-D degenerate Rosenbrock density. Table \ref{tab:tab3} and Figure \ref{fig:fig9} show results similar to those reported in \cite{dhulipala2023efficient}. However, Figures \ref{fig:fig8} and \ref{fig:fig10} indicate that my trained L-HNNs did not explore sufficiently under those two cases, particularly for large values. %Further refinement of the trained L-HNNs may be necessary.

\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{../figures/fig8.png}
\caption{Scatter plot comparison of samples generated from a 2-D Neal’s funnel density, using NUTS and L-HNNs in NUTS with online error monitoring. Comparison of the eCDF plots for the dimensions q1 and q2.}
\label{fig:fig8}
\end{figure}
...
\smallskip
\noindent \textbf{Computational case studies} Table \ref{tab:tab4} and Figure \ref{fig:fig11} demonstrate that our results are consistent with those reported in \cite{dhulipala2023efficient} under the Allen-Cahn stochastic PDE case. In the case of elliptic PDE inference, results from HMC are not available. However, given the target density proposed in the first subsection, the posterior distribution of the values of $k$ at the sensor locations is expected to follow a multivariate normal distribution.
